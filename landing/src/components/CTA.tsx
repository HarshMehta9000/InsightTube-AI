  ...
  return (
    <section className="mx-auto max-w-6xl px-5 py-20">
      <motion.div
        ...
        className="relative overflow-hidden rounded-3xl border border-line bg-bg-subtle px-6 py-14 text-center sm:px-12"
      >
        ...
        <p className="relative mx-auto mt-4 max-w-xl text-muted">
          Clone the repo, add your API keys, and bring up the dashboard and API in containers.
          Dashboard on <span className="font-mono text-fg">:8501</span>, Swagger on{" "}
          <span className="font-mono text-fg">:8000/docs</span>.
        </p>
        <div className="relative mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <a
            href="#search"
            className="inline-flex items-center justify-center rounded-lg border border-line px-5 py-3 text-sm font-semibold text-fg transition-colors hover:bg-bg"
          >
            Replay the demo
          </a>
        </div>
        <pre className="relative mx-auto mt-8 inline-block rounded-lg border border-line bg-bg px-4 py-2 font-mono text-xs text-muted">
          <span className="text-brand">$</span> ./scripts/setup.sh{" "}
          <span className="text-fg/40">&amp;&amp;</span> ./scripts/start.sh
        </pre>
      </motion.div>
    </section>
  );
